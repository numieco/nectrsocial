  ...
  <div>
    ...
    <service-header>
      ...
      <template #description>
        A first-of-its-kind channel management package created exclusively for
        TikTok. We do everything, you watch your business account grow.
      </template>
    </service-header>
    ...
    <div class="l-section">
      <div class="c-capabilities__wrapper">
        ...
        <service-list>
          <template #list-header>Creation / Caption Writing </template>
          <template #list-block>
            <service-list-item>
              <template #list-text>
            ...
            <service-list-item>
              <template #list-text>
                Work with clients to plan organic content for specific dates and
                events.
              </template>
            </service-list-item>
          </template>
        ...
        <service-list>
          <template #list-header>Amplified Community Management</template>
          <template #list-block>
            <service-list-item>
              <template #list-text>
        ...
        <service-list>
          <template #list-header>Reporting / Transparency </template>
          <template #list-block>
            <service-list-item>
              <template #list-text>
                Live Dashboard: Addition of TikTok metric coverage to our live
                reporting dashboard. Anytime access to live reporting dashboard,
