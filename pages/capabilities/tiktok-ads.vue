    ...
    <div class="scroller">
      ...
      <div class="l-section">
        <div class="c-capabilities__wrapper">
          ...
          <service-list>
            <template #list-header>Create </template>
            <template #list-block>
              <service-list-item>
                <template #list-text>
                  Ad caption, headline, and media creation (testing multiple of
                  each)
                </template>
              </service-list-item>
              <service-list-item>
              ...
              <service-list-item>
                <template #list-text>
                  Custom audience development (take full advantage of the
                  customer data you own)
                </template>
              </service-list-item>
              <service-list-item>
                <template #list-text>
                  Pinpointed targeting and retargeting (on a single ad platform
                  or across multiple)
                </template>
              </service-list-item>
            </template>
          ...
          <service-list>
            <template #list-header>Monitor</template>
            <template #list-block>
              <service-list-item>
                <template #list-text> Daily monitoring </template>
              </service-list-item>
              <service-list-item>
                <template #list-text> Weekly optimizations </template>
              </service-list-item>
              <service-list-item>
                <template #list-text>
        ...
        <c-button id="yMIoHeGx" btn-text="Get in Touch" centered typeform />
      </div>
