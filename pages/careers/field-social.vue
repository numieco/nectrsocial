      ...
      <div class="l-container">
        ...
        <div class="c-role">
          <div class="c-role__wrapper">
            <div class="c-role__header">
              <h1 class="alt-h1">Field Social Media Manager</h1>
              <div class="c-role__details">
                ...
                <div class="c-career__details">
                  ...
                  <p class="neutral-text no-margin">
              ...
              <template #list-block>
                ...
                <career-list-item>
                  <template #list-text>
                    ...
                    client-specific organic social posting strategies (primarily
                ...
                <career-list-item>
                  <template #list-text>
                    Monitor social trends to implement into organic strategies.
                  </template>
                </career-list-item>
                <career-list-item>
                  <template #list-text>
                    Edit, organize and manage a social media content hub unique
                    to each client.
                  </template>
                </career-list-item>
                <career-list-item>
                ...
                <career-list-item>
                  <template #list-text>
                    Coordinate client approvals on social media content prior to
                    posting.
                  </template>
                </career-list-item>
                <career-list-item>
            ...
            <career-list>
              ...
              <template #list-block>
                ...
                <career-list-item>
                  <template #list-text>
                    Confident, self-starter able to work independently alongside
                    clients and manage time efficiently.
                  </template>
                </career-list-item>
              </template>
            </career-list>
              ...
              <template #list-block>
                ...
                <career-list-item>
                  <template #list-text>
                    ...
                    the social space, allowing for a flexible work schedule and
                    the ability to enhance our client’s social identities with
                    your creative eye.
                  </template>
                </career-list-item>
                <career-list-item>
