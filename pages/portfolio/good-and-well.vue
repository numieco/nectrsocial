    ...
    <div class="scroller">
      <casestudy-header
        ...
        <template #catchphrase>
          Fine Tuned Brand Voice <br />& 4x Return
        </template>
        <template #description>
          Local candle company Good & Well Supply Co reached out to Nectr to
          manage their social media accounts, create strong digital content and
          deploy conversion ads to help sell Good & Well Supply Co.’s products
          online.
          <br />
          <br />
          We decided that our Medium Social Media Management package would be
          the best place to start. Posting original content to Good & Well
          Supply Co.’s Instagram, Facebook and TikTok channels five times per
          week. With this strategy we re-engaged a previously stagnant audience,
          supplementing Good & Well Supply Co.’s following with new growth as
          well.
        </template>
      </casestudy-header>
      ...
      <div class="l-section no-padding">
        ...
        <casestudy-metrics>
          ...
          <template #metrics>
            <metric-item>
              <template #figure>38%</template>
              <template #description> increase in followers </template>
            </metric-item>
              ...
              <div>
                ...
                <div class="c-writeup">
                  <h5 class="neutral-text" data-paragraph>
                    After rebuilding a strong foundation on Good & Well Supply
                    Co.’s organic social media channels, we introduced a Meta
                    ads strategy to drive conversions on social media. This was
                    an immediate success, as our organic social media posting
                    strategy brought new prospective interest in the Good & Well
                    brand and our meta ads strategy converted that interest into
                    paying custome
                  </h5>
                </div>
              </div>
...
export default {
  ...
  computed: {
    ...
    title() {
      return 'Good & Well Supply Co. | NectrSocial'
    },
  },
