        ...
        <casestudy-metrics>
          <template #metrics>
            <metric-item>
              ...
              <template #description> users reached </template>
            </metric-item>

            <metric-item>
              <template #figure>895</template>
              <template #description> coupons requested </template>
            </metric-item>

            <metric-item>
              <template #figure>13%</template>
              <template #description> in-store conversion rate </template>
            </metric-item>
          </template>
        </casestudy-metrics>
